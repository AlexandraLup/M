 ...
 * @author Alexandra
 */
public class ActualizareClientForm extends InternalWindow {

    int flag = 0;

    public InternalWindow getActualizareClientForm(Connection connection) {
        InternalWindow result = new InternalWindow();
        GridPane root = new GridPane();
        root.add(new Label("Actualizare client"), 1, 0);
        ...
        confirm.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String msg = null;
                try {
                    cstmt = connection.prepareCall("{? = call operatii_clienti.update_client(?, ?, ?)}");
