 ...
 * @author Alexandra
 */
public class StergereClientForm extends InternalWindow {
    int flag = 0;
    public InternalWindow getStergereClientForm(Connection connection) {
        InternalWindow result = new InternalWindow();
        GridPane root = new GridPane();
        root.add(new Label("Stergere client"), 1, 0);
        ...
        confirm.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String msg = null;
                    try {
                    cstmt = connection.prepareCall("{? = call operatii_clienti.delete_client(?)}");
