 ...
 * @author Alexandra
 */
public class CautareAngajatForm {

    int flag = 0;

    public InternalWindow getCautareAngajatForm(Connection connection) {
        ...
        root.add(new Label("Cautare angajat"), 1, 0);
        ...
        confirm.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (nume.getText() != null && prenume.getText() != null) {
                    try {
                    cstmt = connection.prepareCall("{? = call operatii_angajati.cautare_nume_prenume(?, ?)}");
                    ...
                    try {
                    cstmt = connection.prepareCall("{? = call operatii_angajati.cautare_nume(?)}");
                    cstmt.registerOutParameter(1, Types.VARCHAR);
                    cstmt.setString(2, nume.getText());
                    cstmt.executeQuery();
