 ...
 * @author Alexandra
 */
public class ActualizareAngajatForm extends InternalWindow {
    int flag = 0;
    public InternalWindow getActualizareAngajatForm(Connection connection) {
        InternalWindow result = new InternalWindow();
        GridPane root = new GridPane();
        root.add(new Label("Actualizare angajat"), 1, 0);
        ...
        confirm.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String msg = null;
                    try {
                    cstmt = connection.prepareCall("{? = call operatii_angajati.update_angajat(?, ?, ?)}");
