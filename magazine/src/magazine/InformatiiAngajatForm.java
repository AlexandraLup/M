 ...
 * @author Alexandra
 */
public class InformatiiAngajatForm extends InternalWindow {
    int flag = 0;
    public InternalWindow getInformatiiAngajatForm(Connection connection) {
        InternalWindow result = new InternalWindow();
        GridPane root = new GridPane();
        root.add(new Label("Informatii angajat"), 1, 0);
        ...
        confirm.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String msg = null;
                    try {
                    cstmt = connection.prepareCall("{? = call operatii_angajati.interogare_angajat(?)}");
