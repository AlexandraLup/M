 ...
 * @author Alexandra
 */
public class StergereAngajatForm extends InternalWindow {
    int flag = 0;
    public InternalWindow getStergereAngajatForm(Connection connection) {
        InternalWindow result = new InternalWindow();
        GridPane root = new GridPane();
        root.add(new Label("Stergere angajat"), 1, 0);
        ...
        confirm.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String msg = null;
                    try {
                    cstmt = connection.prepareCall("{? = call operatii_angajati.delete_angajat(?)}");
